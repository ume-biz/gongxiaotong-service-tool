...
CREATE TABLE `ORDER_ITEM` (
    ...
    `ORDER_ITEM_SEQ` INT NOT NULL	 COMMENT '品类编号',
    `ORDER_ITEM_CODE` VARCHAR(32) BINARY 	 COMMENT '品类编号',
    `ORDER_ITEM_DESC` VARCHAR(256) BINARY 	 COMMENT '品类描述',
    `ORDER_ITEM_SPECS` VARCHAR(64) BINARY 	 COMMENT '规格',
    `ORDER_ITEM_QUANTITY` INT 	 COMMENT '数量',
    `ORDER_ITEM_ESTIMATION` INT 	 COMMENT '期望单价(MAX)',
...
CREATE TABLE `ORDER_ITEM_HT` (
    ...
    `ORDER_ITEM_SEQ` INT COMMENT '品类编号',
    `ORDER_ITEM_CODE` VARCHAR(32) COMMENT '品类编号',
    `ORDER_ITEM_DESC` VARCHAR(256) COMMENT '品类描述',
    `ORDER_ITEM_SPECS` VARCHAR(64) COMMENT '规格',
    `ORDER_ITEM_QUANTITY` INT COMMENT '数量',
    `ORDER_ITEM_ESTIMATION` INT COMMENT '期望单价(MAX)',

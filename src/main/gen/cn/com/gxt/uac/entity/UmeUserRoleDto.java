...
/**
 * Entity class map to table "供销通用户角色关系表"
 *
 * @author ume-team
 */
@Entity
@Table(name="UME_USER_ROLE")
@TableDesc(label="供销通用户角色关系表")
public class UmeUserRoleDto extends TableEntity implements Serializable {
    ...
    */
    @ColumnDesc(index=(2 + 1), type="VARCHAR", label="Create Author")
    ...
    */
    @ColumnDesc(index=(2 + 3), type="VARCHAR", label="Update Author")
    ...
    */
    ...
    public static class SQLID {
        public static final String INSERT = "cn.com.gxt.uac.entity.UME_USER_ROLE_INSERT"; 

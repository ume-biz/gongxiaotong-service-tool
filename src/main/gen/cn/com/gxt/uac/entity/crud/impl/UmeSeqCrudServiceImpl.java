...
import cn.com.gxt.uac.entity.UmeSeqDto;
import cn.com.gxt.uac.entity.crud.UmeSeqCrudService;

/**
 * 供销通自增长序列管理表:UME_SEQ<br>
...
public class UmeSeqCrudServiceImpl extends BaseDBComponent implements UmeSeqCrudService {
    /* (non-Javadoc)
     * 
     * @see cn.com.gxt.uac.entity.crud.impl.UmeSeqCrudService
     */
    @Override
    @TransactionRequired

 ...
 */
@Entity
@Table(name="UH_ORDER_ITEM")
@TableDesc(label="需求发布明细信息表")
public class UhOrderItemDto extends TableEntity implements Serializable {
   /**
    ...
    */
    @NotEmpty
    @Id
    @ColumnDesc(index=1, type="TIMESTAMP", label="更新时间戳")
    ...
    * 1:R 2:U 4:C 8:D
    */
    @ColumnDesc(index=2, type="INT", label="更新操作类别")
    ...
    */
    @Size(max=32)
    @ColumnDesc(index=3, type="VARCHAR", label="需求编号")
    ...
    * 品类编号 
    */
    @ColumnDesc(index=4, type="INT", label="品类编号")
    @Column(name="ORDER_ITEM_SEQ", nullable=true)
    ...
    */
    @Size(max=32)
    @ColumnDesc(index=5, type="VARCHAR", label="品类编号")
    ...
    */
    @Size(max=256)
    @ColumnDesc(index=6, type="VARCHAR", label="品类描述")
    ...
    */
    @Size(max=64)
    @ColumnDesc(index=7, type="VARCHAR", label="规格")
    ...
    * 数量 
    */
    @ColumnDesc(index=8, type="INT", label="数量")
    ...
    * 期望单价(MAX) 
    */
    @ColumnDesc(index=9, type="INT", label="期望单价(MAX)")
    ...
    */
    @Size(max=128)
    @ColumnDesc(index=10, type="VARCHAR", label="物流单号")
    ...
    */
    @Size(max=256)
    @ColumnDesc(index=11, type="VARCHAR", label="物流描述/动态")
    ...
    * 物流签收状态 
    */
    @ColumnDesc(index=12, type="INT", label="物流签收状态")
    ...
    */
    @Size(max=256)
    @ColumnDesc(index=13, type="VARCHAR", label="备注")
    ...
    */
     ...
     * @return
     */
    public UhOrderItemDto copyFrom(
            Property... selectProperties) {
        if (selectProperties == null) {
            return null;
        }
        UhOrderItemDto newInstance = new UhOrderItemDto();
    ...
    public static class SQLID {
        public static final String INSERT = "cn.com.gxt.entity.UH_ORDER_ITEM_INSERT"; 
        public static final String UPDATE = "cn.com.gxt.entity.UH_ORDER_ITEM_UPDATE"; 
        public static final String SMART_UPDATE = "cn.com.gxt.entity.UH_ORDER_ITEM_SMART_UPDATE"; 
        public static final String DELETE = "cn.com.gxt.entity.UH_ORDER_ITEM_DELETE"; 
        public static final String FIND = "cn.com.gxt.entity.UH_ORDER_ITEM_FIND"; 
        public static final String FIND_FOR_UPDATE = "cn.com.gxt.entity.UH_ORDER_ITEM_FIND_FOR_UPDATE"; 
        public static final String SEARCH = "cn.com.gxt.entity.UH_ORDER_ITEM_SEARCH"; 
        public static final String LIKE_SEARCH = "cn.com.gxt.entity.UH_ORDER_ITEM_LIKE_SEARCH"; 
        public static final String DYNA_SEARCH = "cn.com.gxt.entity.UH_ORDER_ITEM_DYNA_SEARCH"; 
        public static final String COUNT = "cn.com.gxt.entity.UH_ORDER_ITEM_COUNT";
    } 
     ...
     */
    public static String TableName = "UH_ORDER_ITEM";

...
public class UhOrderDto extends TableEntity implements Serializable {
   /**
    ...
    */
    @Size(max=256)
    @ColumnDesc(index=4, type="VARCHAR", label="需求描述")
    ...
    * 期望发货时间 
    */
    @ColumnDesc(index=5, type="DATE", label="期望发货时间")
    ...
    */
    ...
    @Column(name="ORDER_DELIVERY_ADDRESS", nullable=true, length=256)
    ...
    * 需求总价估算 
    */
    @ColumnDesc(index=9, type="INT", label="需求总价估算")
    ...
    * 需求状态 
    */
    @ColumnDesc(index=10, type="INT", label="需求状态")
    ...
    * 需求有效期(开始) 
    */
    @ColumnDesc(index=11, type="TIMESTAMP", label="需求有效期(开始)")
    ...
    * 需求有效期(结束) 
    */
    @ColumnDesc(index=12, type="TIMESTAMP", label="需求有效期(结束)")
    ...
    * 最多候选竞标件数 
    */
    @ColumnDesc(index=13, type="INT", label="最多候选竞标件数")
    ...
    */
    @Size(max=32)
    @ColumnDesc(index=14, type="VARCHAR", label="最终选定竞标者ID")
    ...
    * 最终成交价格 
    */
    @ColumnDesc(index=15, type="INT", label="最终成交价格")
    ...
    */
    @Size(max=256)
    @ColumnDesc(index=16, type="VARCHAR", label="备注")
    ...
    */
     ...
     * @return
     */
    public UhOrderDto copyFrom(
            Property... selectProperties) {
        if (selectProperties == null) {
            return null;
        }
        UhOrderDto newInstance = new UhOrderDto();
    ...
    public static class SQLID {
        public static final String INSERT = "cn.com.gxt.entity.UH_ORDER_INSERT"; 
        public static final String UPDATE = "cn.com.gxt.entity.UH_ORDER_UPDATE"; 
        public static final String SMART_UPDATE = "cn.com.gxt.entity.UH_ORDER_SMART_UPDATE"; 
        public static final String DELETE = "cn.com.gxt.entity.UH_ORDER_DELETE"; 
        public static final String FIND = "cn.com.gxt.entity.UH_ORDER_FIND"; 
        public static final String FIND_FOR_UPDATE = "cn.com.gxt.entity.UH_ORDER_FIND_FOR_UPDATE"; 
        public static final String SEARCH = "cn.com.gxt.entity.UH_ORDER_SEARCH"; 
        public static final String LIKE_SEARCH = "cn.com.gxt.entity.UH_ORDER_LIKE_SEARCH"; 
        public static final String DYNA_SEARCH = "cn.com.gxt.entity.UH_ORDER_DYNA_SEARCH"; 
        public static final String COUNT = "cn.com.gxt.entity.UH_ORDER_COUNT";
    } 
     ...
     */
    public static String TableName = "UH_ORDER";
